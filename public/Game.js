...
class Game {
    ...
    constructor () {
        ...
        /* AGREGADOS PARA EL EJERCICIO */
        this.score = 0;  // Inicializa el score en cero 
    ...
    endGame () {
        this.ended = true;
        let finish = this.player.lives > 0 ? YOU_WIN : GAME_OVER_PICTURE;
        let gameOver = new Entity(this, this.width / 2, "auto", this.width / 4, this.height / 4, 0, finish)
        gameOver.render();
    }
